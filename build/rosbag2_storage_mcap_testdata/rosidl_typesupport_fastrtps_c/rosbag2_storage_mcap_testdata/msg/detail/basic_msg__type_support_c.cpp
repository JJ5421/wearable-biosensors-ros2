...
#include "rosbag2_storage_mcap_testdata/msg/detail/basic_msg__rosidl_typesupport_fastrtps_c.h"
...
using _BasicMsg__ros_msg_type = rosbag2_storage_mcap_testdata__msg__BasicMsg;
  ...
  void * untyped_ros_message)
{
  ...
  _BasicMsg__ros_msg_type * ros_message = static_cast<_BasicMsg__ros_msg_type *>(untyped_ros_message);
  // Field name: c
  {
    cdr >> ros_message->c;
  }
...
static uint32_t _BasicMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rosbag2_storage_mcap_testdata__msg__BasicMsg(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosbag2_storage_mcap_testdata__msg__BasicMsg;
    is_plain =
      (
      offsetof(DataType, c) +
      last_member_size
...
static size_t _BasicMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosbag2_storage_mcap_testdata__msg__BasicMsg(
...
static message_type_support_callbacks_t __callbacks_BasicMsg = {
...
static rosidl_message_type_support_t _BasicMsg__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_BasicMsg,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rosbag2_storage_mcap_testdata, msg, BasicMsg)() {
  return &_BasicMsg__type_support;
}
