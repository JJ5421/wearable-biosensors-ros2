...
#include "rosbag2_storage_mcap_testdata/msg/detail/basic_idl__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rosbag2_storage_mcap_testdata::msg::BasicIdl;
    is_plain =
      (
      offsetof(DataType, x) +
      last_member_size
...
static size_t _BasicIdl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BasicIdl(full_bounded, is_plain, 0);
...
{
  return &rosbag2_storage_mcap_testdata::msg::typesupport_fastrtps_cpp::_BasicIdl__handle;
}
