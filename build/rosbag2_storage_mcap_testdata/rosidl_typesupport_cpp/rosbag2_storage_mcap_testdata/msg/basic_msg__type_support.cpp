...
static const _BasicMsg_type_support_symbol_names_t _BasicMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosbag2_storage_mcap_testdata, msg, BasicMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosbag2_storage_mcap_testdata, msg, BasicMsg)),
  }
};
...
{
  return &::rosbag2_storage_mcap_testdata::msg::rosidl_typesupport_cpp::BasicMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rosbag2_storage_mcap_testdata, msg, BasicMsg)() {
  return get_message_type_support_handle<rosbag2_storage_mcap_testdata::msg::BasicMsg>();
}
