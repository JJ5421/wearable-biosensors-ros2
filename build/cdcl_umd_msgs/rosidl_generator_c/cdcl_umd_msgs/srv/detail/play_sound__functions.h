...
#ifndef CDCL_UMD_MSGS__SRV__DETAIL__PLAY_SOUND__FUNCTIONS_H_
#define CDCL_UMD_MSGS__SRV__DETAIL__PLAY_SOUND__FUNCTIONS_H_
 ...
 * calls
 * cdcl_umd_msgs__srv__PlaySound_Request__init().
...
/**
 * It calls
 * cdcl_umd_msgs__srv__PlaySound_Request__fini()
 ...
 * cdcl_umd_msgs__srv__PlaySound_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * cdcl_umd_msgs__srv__PlaySound_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cdcl_umd_msgs__srv__PlaySound_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cdcl_umd_msgs
...
/**
 * It calls
 * cdcl_umd_msgs__srv__PlaySound_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_cdcl_umd_msgs
...
/**
 * It allocates the memory for the array and calls
 * cdcl_umd_msgs__srv__PlaySound_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cdcl_umd_msgs
...
/**
 * It calls
 * cdcl_umd_msgs__srv__PlaySound_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CDCL_UMD_MSGS__SRV__DETAIL__PLAY_SOUND__FUNCTIONS_H_
