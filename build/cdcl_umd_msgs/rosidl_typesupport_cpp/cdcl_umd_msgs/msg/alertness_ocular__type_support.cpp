...
static const _AlertnessOcular_type_support_symbol_names_t _AlertnessOcular_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cdcl_umd_msgs, msg, AlertnessOcular)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cdcl_umd_msgs, msg, AlertnessOcular)),
  }
};
...
{
  return &::cdcl_umd_msgs::msg::rosidl_typesupport_cpp::AlertnessOcular_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cdcl_umd_msgs, msg, AlertnessOcular)() {
  return get_message_type_support_handle<cdcl_umd_msgs::msg::AlertnessOcular>();
}
