...
static const _NavSatFixArray_type_support_symbol_names_t _NavSatFixArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cdcl_umd_msgs, msg, NavSatFixArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cdcl_umd_msgs, msg, NavSatFixArray)),
  }
};
...
{
  return &::cdcl_umd_msgs::msg::rosidl_typesupport_cpp::NavSatFixArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, cdcl_umd_msgs, msg, NavSatFixArray)() {
  return get_message_type_support_handle<cdcl_umd_msgs::msg::NavSatFixArray>();
}
