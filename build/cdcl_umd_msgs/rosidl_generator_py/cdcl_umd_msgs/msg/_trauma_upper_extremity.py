...
class Metaclass_TraumaUpperExtremity(type):
    """Metaclass of message 'TraumaUpperExtremity'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'cdcl_umd_msgs.msg.TraumaUpperExtremity')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__trauma_upper_extremity
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__trauma_upper_extremity
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__trauma_upper_extremity
            cls._TYPE_SUPPORT = module.type_support_msg__msg__trauma_upper_extremity
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__trauma_upper_extremity
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'POSTERIORS__DEFAULT': array.array('d', (0.34, 0.33, 0.33, )),
            'HYPOTHESIS_NAMES__DEFAULT': ['wound', 'amputation', 'normal'],
        }

    @property
    def NAME(self):
        """Message constant 'NAME'."""
        return Metaclass_TraumaUpperExtremity.__constants['NAME']

    @property
    def TYPE(self):
        """Message constant 'TYPE'."""
        return Metaclass_TraumaUpperExtremity.__constants['TYPE']

    @property
    def NUM_HYPOTHESES(self):
        """Message constant 'NUM_HYPOTHESES'."""
        return Metaclass_TraumaUpperExtremity.__constants['NUM_HYPOTHESES']

    @property
    def MAX_POSTERIOR_INDEX(self):
        """Message constant 'MAX_POSTERIOR_INDEX'."""
        return Metaclass_TraumaUpperExtremity.__constants['MAX_POSTERIOR_INDEX']

    @property
    def POSTERIORS__DEFAULT(cls):
        """Return default value for message field 'posteriors'."""
        return array.array('d', (0.34, 0.33, 0.33, ))

    @property
    def HYPOTHESIS_NAMES__DEFAULT(cls):
        """Return default value for message field 'hypothesis_names'."""
        return ['wound', 'amputation', 'normal']


class TraumaUpperExtremity(metaclass=Metaclass_TraumaUpperExtremity):
    """
    Message class 'TraumaUpperExtremity'.
    ...
    def __init__(self, **kwargs):
        ...
        self.posteriors = kwargs.get(
            'posteriors', TraumaUpperExtremity.POSTERIORS__DEFAULT)
        self.hypothesis_names = kwargs.get(
            'hypothesis_names', TraumaUpperExtremity.HYPOTHESIS_NAMES__DEFAULT)
