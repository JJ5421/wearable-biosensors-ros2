...
class Metaclass_SevereHemorrhage(type):
    """Metaclass of message 'SevereHemorrhage'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'cdcl_umd_msgs.msg.SevereHemorrhage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__severe_hemorrhage
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__severe_hemorrhage
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__severe_hemorrhage
            cls._TYPE_SUPPORT = module.type_support_msg__msg__severe_hemorrhage
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__severe_hemorrhage
    ...
    def NAME(self):
        ...
        return Metaclass_SevereHemorrhage.__constants['NAME']

    @property
    def TYPE(self):
        """Message constant 'TYPE'."""
        return Metaclass_SevereHemorrhage.__constants['TYPE']

    @property
    def NUM_HYPOTHESES(self):
        """Message constant 'NUM_HYPOTHESES'."""
        return Metaclass_SevereHemorrhage.__constants['NUM_HYPOTHESES']

    @property
    def MAX_POSTERIOR_INDEX(self):
        """Message constant 'MAX_POSTERIOR_INDEX'."""
        return Metaclass_SevereHemorrhage.__constants['MAX_POSTERIOR_INDEX']
...
class SevereHemorrhage(metaclass=Metaclass_SevereHemorrhage):
    """
    Message class 'SevereHemorrhage'.
    ...
    def __init__(self, **kwargs):
        ...
        self.posteriors = kwargs.get(
            'posteriors', SevereHemorrhage.POSTERIORS__DEFAULT)
        self.hypothesis_names = kwargs.get(
            'hypothesis_names', SevereHemorrhage.HYPOTHESIS_NAMES__DEFAULT)
