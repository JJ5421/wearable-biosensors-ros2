...
#include "cdcl_umd_msgs/srv/detail/play_sound__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cdcl_umd_msgs::srv::PlaySound_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cdcl_umd_msgs::srv::PlaySound_Request & ros_message)
{
  // Member: file_name
  cdr >> ros_message.file_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cdcl_umd_msgs::srv::PlaySound_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cdcl_umd_msgs::srv::PlaySound_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cdcl_umd_msgs::srv::PlaySound_Request *>(
    untyped_ros_message);
...
{
  return &cdcl_umd_msgs::srv::typesupport_fastrtps_cpp::_PlaySound_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cdcl_umd_msgs, srv, PlaySound_Request)() {
  return &cdcl_umd_msgs::srv::typesupport_fastrtps_cpp::_PlaySound_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cdcl_umd_msgs
cdr_serialize(
  const cdcl_umd_msgs::srv::PlaySound_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cdcl_umd_msgs::srv::PlaySound_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = cdcl_umd_msgs::srv::PlaySound_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cdcl_umd_msgs::srv::PlaySound_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<cdcl_umd_msgs::srv::PlaySound_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &cdcl_umd_msgs::srv::typesupport_fastrtps_cpp::_PlaySound_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cdcl_umd_msgs, srv, PlaySound_Response)() {
  return &cdcl_umd_msgs::srv::typesupport_fastrtps_cpp::_PlaySound_Response__handle;
}
...
{
  return &cdcl_umd_msgs::srv::typesupport_fastrtps_cpp::_PlaySound__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cdcl_umd_msgs, srv, PlaySound)() {
  return &cdcl_umd_msgs::srv::typesupport_fastrtps_cpp::_PlaySound__handle;
}
