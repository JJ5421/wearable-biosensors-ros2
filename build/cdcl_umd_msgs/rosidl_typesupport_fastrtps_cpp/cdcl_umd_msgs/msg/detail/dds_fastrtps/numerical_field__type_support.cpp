...
#include "cdcl_umd_msgs/msg/detail/numerical_field__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cdcl_umd_msgs::msg::NumericalField & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cdcl_umd_msgs::msg::NumericalField & ros_message)
{
  // Member: field
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cdcl_umd_msgs::msg::NumericalField;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cdcl_umd_msgs::msg::NumericalField *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cdcl_umd_msgs::msg::NumericalField *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _NumericalField__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cdcl_umd_msgs::msg::NumericalField *>(
...
static size_t _NumericalField__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_NumericalField(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _NumericalField__callbacks = {
  "cdcl_umd_msgs::msg",
  "NumericalField",
...
static rosidl_message_type_support_t _NumericalField__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_NumericalField__callbacks,
...
{
  return &cdcl_umd_msgs::msg::typesupport_fastrtps_cpp::_NumericalField__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cdcl_umd_msgs, msg, NumericalField)() {
  return &cdcl_umd_msgs::msg::typesupport_fastrtps_cpp::_NumericalField__handle;
}
