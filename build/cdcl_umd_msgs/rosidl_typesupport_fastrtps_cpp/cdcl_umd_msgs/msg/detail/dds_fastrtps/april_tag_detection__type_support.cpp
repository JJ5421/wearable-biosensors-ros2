...
#include "cdcl_umd_msgs/msg/detail/april_tag_detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cdcl_umd_msgs::msg::AprilTagDetection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cdcl_umd_msgs::msg::AprilTagDetection & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cdcl_umd_msgs::msg::AprilTagDetection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cdcl_umd_msgs::msg::AprilTagDetection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cdcl_umd_msgs::msg::AprilTagDetection *>(
    untyped_ros_message);
...
{
  return &cdcl_umd_msgs::msg::typesupport_fastrtps_cpp::_AprilTagDetection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cdcl_umd_msgs, msg, AprilTagDetection)() {
  return &cdcl_umd_msgs::msg::typesupport_fastrtps_cpp::_AprilTagDetection__handle;
}
