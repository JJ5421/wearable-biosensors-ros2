...
#include "cdcl_umd_msgs/msg/detail/vitals__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cdcl_umd_msgs::msg::Vitals;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cdcl_umd_msgs::msg::Vitals *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cdcl_umd_msgs::msg::Vitals *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Vitals__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cdcl_umd_msgs::msg::Vitals *>(
...
static size_t _Vitals__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Vitals(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _Vitals__callbacks = {
  "cdcl_umd_msgs::msg",
  "Vitals",
...
static rosidl_message_type_support_t _Vitals__handle = {
...
{
  return &cdcl_umd_msgs::msg::typesupport_fastrtps_cpp::_Vitals__handle;
}
