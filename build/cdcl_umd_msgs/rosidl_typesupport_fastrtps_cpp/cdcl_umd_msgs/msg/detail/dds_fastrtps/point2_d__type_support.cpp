...
#include "cdcl_umd_msgs/msg/detail/point2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const cdcl_umd_msgs::msg::Point2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cdcl_umd_msgs::msg::Point2D & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cdcl_umd_msgs::msg::Point2D;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const cdcl_umd_msgs::msg::Point2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cdcl_umd_msgs::msg::Point2D *>(
    untyped_ros_message);
...
{
  return &cdcl_umd_msgs::msg::typesupport_fastrtps_cpp::_Point2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cdcl_umd_msgs, msg, Point2D)() {
  return &cdcl_umd_msgs::msg::typesupport_fastrtps_cpp::_Point2D__handle;
}
