...
#include "cdcl_umd_msgs/msg/detail/target_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const cdcl_umd_msgs::msg::Target &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const cdcl_umd_msgs::msg::TargetList & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  cdcl_umd_msgs::msg::TargetList & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_cdcl_umd_msgs
max_serialized_size_TargetList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: targets
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        cdcl_umd_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Target(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = cdcl_umd_msgs::msg::TargetList;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const cdcl_umd_msgs::msg::TargetList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<cdcl_umd_msgs::msg::TargetList *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TargetList__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const cdcl_umd_msgs::msg::TargetList *>(
...
static size_t _TargetList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TargetList(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TargetList__callbacks = {
  "cdcl_umd_msgs::msg",
  "TargetList",
...
static rosidl_message_type_support_t _TargetList__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TargetList__callbacks,
...
{
  return &cdcl_umd_msgs::msg::typesupport_fastrtps_cpp::_TargetList__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, cdcl_umd_msgs, msg, TargetList)() {
  return &cdcl_umd_msgs::msg::typesupport_fastrtps_cpp::_TargetList__handle;
}
