...
static const _PlaySound_Request_type_support_symbol_names_t _PlaySound_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cdcl_umd_msgs, srv, PlaySound_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cdcl_umd_msgs, srv, PlaySound_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cdcl_umd_msgs, srv, PlaySound_Request)() {
  return &::cdcl_umd_msgs::srv::rosidl_typesupport_c::PlaySound_Request_message_type_support_handle;
}
...
static const _PlaySound_Response_type_support_symbol_names_t _PlaySound_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cdcl_umd_msgs, srv, PlaySound_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cdcl_umd_msgs, srv, PlaySound_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cdcl_umd_msgs, srv, PlaySound_Response)() {
  return &::cdcl_umd_msgs::srv::rosidl_typesupport_c::PlaySound_Response_message_type_support_handle;
}
...
static const _PlaySound_type_support_symbol_names_t _PlaySound_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cdcl_umd_msgs, srv, PlaySound)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cdcl_umd_msgs, srv, PlaySound)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, cdcl_umd_msgs, srv, PlaySound)() {
  return &::cdcl_umd_msgs::srv::rosidl_typesupport_c::PlaySound_service_type_support_handle;
}
