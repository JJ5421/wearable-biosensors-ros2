...
static const _InjuryReport_Request_type_support_symbol_names_t _InjuryReport_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cdcl_umd_msgs, srv, InjuryReport_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cdcl_umd_msgs, srv, InjuryReport_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cdcl_umd_msgs, srv, InjuryReport_Request)() {
  return &::cdcl_umd_msgs::srv::rosidl_typesupport_c::InjuryReport_Request_message_type_support_handle;
}
...
static const _InjuryReport_Response_type_support_symbol_names_t _InjuryReport_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cdcl_umd_msgs, srv, InjuryReport_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cdcl_umd_msgs, srv, InjuryReport_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cdcl_umd_msgs, srv, InjuryReport_Response)() {
  return &::cdcl_umd_msgs::srv::rosidl_typesupport_c::InjuryReport_Response_message_type_support_handle;
}
...
static const _InjuryReport_type_support_symbol_names_t _InjuryReport_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cdcl_umd_msgs, srv, InjuryReport)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cdcl_umd_msgs, srv, InjuryReport)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, cdcl_umd_msgs, srv, InjuryReport)() {
  return &::cdcl_umd_msgs::srv::rosidl_typesupport_c::InjuryReport_service_type_support_handle;
}
