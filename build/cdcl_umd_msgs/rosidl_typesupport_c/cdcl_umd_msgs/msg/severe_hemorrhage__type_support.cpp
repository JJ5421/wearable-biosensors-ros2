...
static const _SevereHemorrhage_type_support_symbol_names_t _SevereHemorrhage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cdcl_umd_msgs, msg, SevereHemorrhage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cdcl_umd_msgs, msg, SevereHemorrhage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, cdcl_umd_msgs, msg, SevereHemorrhage)() {
  return &::cdcl_umd_msgs::msg::rosidl_typesupport_c::SevereHemorrhage_message_type_support_handle;
}
