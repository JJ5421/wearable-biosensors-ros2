...
{
  new (message_memory) cdcl_umd_msgs::msg::AprilTagDetection(_init);
}

void AprilTagDetection_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cdcl_umd_msgs::msg::AprilTagDetection *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AprilTagDetection_message_member_array[4] = {
  {
    ...
    offsetof(cdcl_umd_msgs::msg::AprilTagDetection, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cdcl_umd_msgs::msg::AprilTagDetection, tag_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cdcl_umd_msgs::msg::AprilTagDetection, latitude),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cdcl_umd_msgs::msg::AprilTagDetection, longitude),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AprilTagDetection_message_members = {
  ...
  4,  // number of fields
  sizeof(cdcl_umd_msgs::msg::AprilTagDetection),
...
get_message_type_support_handle<cdcl_umd_msgs::msg::AprilTagDetection>()
{
  return &::cdcl_umd_msgs::msg::rosidl_typesupport_introspection_cpp::AprilTagDetection_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cdcl_umd_msgs, msg, AprilTagDetection)() {
  return &::cdcl_umd_msgs::msg::rosidl_typesupport_introspection_cpp::AprilTagDetection_message_type_support_handle;
}
