...
#include "cdcl_umd_msgs/msg/detail/alertness_ocular__rosidl_typesupport_fastrtps_c.h"
...
using _AlertnessOcular__ros_msg_type = cdcl_umd_msgs__msg__AlertnessOcular;

static bool _AlertnessOcular__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AlertnessOcular__ros_msg_type * ros_message = static_cast<const _AlertnessOcular__ros_msg_type *>(untyped_ros_message);
...
static bool _AlertnessOcular__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _AlertnessOcular__ros_msg_type * ros_message = static_cast<_AlertnessOcular__ros_msg_type *>(untyped_ros_message);
  // Field name: posteriors
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
...
size_t get_serialized_size_cdcl_umd_msgs__msg__AlertnessOcular(
  const void * untyped_ros_message,
...
static uint32_t _AlertnessOcular__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cdcl_umd_msgs__msg__AlertnessOcular(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cdcl_umd_msgs
size_t max_serialized_size_cdcl_umd_msgs__msg__AlertnessOcular(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cdcl_umd_msgs__msg__AlertnessOcular;
    is_plain =
      (
...
static size_t _AlertnessOcular__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_cdcl_umd_msgs__msg__AlertnessOcular(
...
static message_type_support_callbacks_t __callbacks_AlertnessOcular = {
  "cdcl_umd_msgs::msg",
  "AlertnessOcular",
  _AlertnessOcular__cdr_serialize,
  _AlertnessOcular__cdr_deserialize,
  _AlertnessOcular__get_serialized_size,
  _AlertnessOcular__max_serialized_size
};

static rosidl_message_type_support_t _AlertnessOcular__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_AlertnessOcular,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cdcl_umd_msgs, msg, AlertnessOcular)() {
  return &_AlertnessOcular__type_support;
}
