...
#include "cdcl_umd_msgs/msg/detail/target_list__rosidl_typesupport_fastrtps_c.h"
...
#include "cdcl_umd_msgs/msg/detail/target__functions.h"  // targets
...
using _TargetList__ros_msg_type = cdcl_umd_msgs__msg__TargetList;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: targets
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, cdcl_umd_msgs, msg, Target
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: targets
  {
    ...
    if (ros_message->targets.data) {
      cdcl_umd_msgs__msg__Target__Sequence__fini(&ros_message->targets);
    }
...
size_t get_serialized_size_cdcl_umd_msgs__msg__TargetList(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TargetList__ros_msg_type * ros_message = static_cast<const _TargetList__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name targets
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_cdcl_umd_msgs__msg__Target(
...
static uint32_t _TargetList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cdcl_umd_msgs__msg__TargetList(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cdcl_umd_msgs
size_t max_serialized_size_cdcl_umd_msgs__msg__TargetList(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: targets
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_cdcl_umd_msgs__msg__Target(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = cdcl_umd_msgs__msg__TargetList;
    is_plain =
      (
...
static size_t _TargetList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cdcl_umd_msgs__msg__TargetList(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cdcl_umd_msgs, msg, TargetList)() {
