...
#include "cdcl_umd_msgs/msg/detail/nav_sat_fix_array__rosidl_typesupport_fastrtps_c.h"
...
#include "sensor_msgs/msg/detail/nav_sat_fix__functions.h"  // fixes
...
using _NavSatFixArray__ros_msg_type = cdcl_umd_msgs__msg__NavSatFixArray;
  ...
  void * untyped_ros_message)
{
  ...
  _NavSatFixArray__ros_msg_type * ros_message = static_cast<_NavSatFixArray__ros_msg_type *>(untyped_ros_message);
  // Field name: fixes
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
    ...
    if (ros_message->fixes.data) {
      sensor_msgs__msg__NavSatFix__Sequence__fini(&ros_message->fixes);
    }
...
size_t get_serialized_size_cdcl_umd_msgs__msg__NavSatFixArray(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _NavSatFixArray__ros_msg_type * ros_message = static_cast<const _NavSatFixArray__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _NavSatFixArray__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_cdcl_umd_msgs__msg__NavSatFixArray(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_cdcl_umd_msgs
size_t max_serialized_size_cdcl_umd_msgs__msg__NavSatFixArray(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = cdcl_umd_msgs__msg__NavSatFixArray;
    is_plain =
      (
      offsetof(DataType, fixes) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _NavSatFixArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_cdcl_umd_msgs__msg__NavSatFixArray(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, cdcl_umd_msgs, msg, NavSatFixArray)() {
