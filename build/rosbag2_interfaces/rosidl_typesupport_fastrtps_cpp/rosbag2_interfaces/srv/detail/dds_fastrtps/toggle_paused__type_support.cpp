...
static size_t _TogglePaused_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TogglePaused_Request(full_bounded, is_plain, 0);
...
{
  return &rosbag2_interfaces::srv::typesupport_fastrtps_cpp::_TogglePaused_Request__handle;
}
...
static size_t _TogglePaused_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TogglePaused_Response(full_bounded, is_plain, 0);
...
{
  return &rosbag2_interfaces::srv::typesupport_fastrtps_cpp::_TogglePaused_Response__handle;
}
...
{
  return &rosbag2_interfaces::srv::typesupport_fastrtps_cpp::_TogglePaused__handle;
}
