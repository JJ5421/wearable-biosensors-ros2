...
static size_t _Burst_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Burst_Request(full_bounded, is_plain, 0);
...
{
  return &rosbag2_interfaces::srv::typesupport_fastrtps_cpp::_Burst_Request__handle;
}
...
static size_t _Burst_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Burst_Response(full_bounded, is_plain, 0);
...
{
  return &rosbag2_interfaces::srv::typesupport_fastrtps_cpp::_Burst_Response__handle;
}
...
{
  return &rosbag2_interfaces::srv::typesupport_fastrtps_cpp::_Burst__handle;
}
