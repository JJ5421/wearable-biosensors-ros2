...
static size_t _PlayNext_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PlayNext_Request(full_bounded, is_plain, 0);
...
{
  return &rosbag2_interfaces::srv::typesupport_fastrtps_cpp::_PlayNext_Request__handle;
}
...
static size_t _PlayNext_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PlayNext_Response(full_bounded, is_plain, 0);
...
{
  return &rosbag2_interfaces::srv::typesupport_fastrtps_cpp::_PlayNext_Response__handle;
}
...
{
  return &rosbag2_interfaces::srv::typesupport_fastrtps_cpp::_PlayNext__handle;
}
