...
static size_t _GetRate_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetRate_Request(full_bounded, is_plain, 0);
...
{
  return &rosbag2_interfaces::srv::typesupport_fastrtps_cpp::_GetRate_Request__handle;
}
...
static size_t _GetRate_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetRate_Response(full_bounded, is_plain, 0);
...
{
  return &rosbag2_interfaces::srv::typesupport_fastrtps_cpp::_GetRate_Response__handle;
}
...
{
  return &rosbag2_interfaces::srv::typesupport_fastrtps_cpp::_GetRate__handle;
}
