...
static const _ReadSplitEvent_type_support_symbol_names_t _ReadSplitEvent_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rosbag2_interfaces, msg, ReadSplitEvent)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosbag2_interfaces, msg, ReadSplitEvent)),
  }
};
...
{
  return &::rosbag2_interfaces::msg::rosidl_typesupport_cpp::ReadSplitEvent_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rosbag2_interfaces, msg, ReadSplitEvent)() {
  return get_message_type_support_handle<rosbag2_interfaces::msg::ReadSplitEvent>();
}
