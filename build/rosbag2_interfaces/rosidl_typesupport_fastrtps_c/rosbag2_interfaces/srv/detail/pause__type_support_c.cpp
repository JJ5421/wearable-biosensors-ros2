...
static uint32_t _Pause_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rosbag2_interfaces__srv__Pause_Request(
...
static size_t _Pause_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosbag2_interfaces__srv__Pause_Request(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_rosbag2_interfaces__srv__Pause_Response(
      untyped_ros_message, 0));
}
...
static size_t _Pause_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rosbag2_interfaces__srv__Pause_Response(
    full_bounded, is_plain, 0);
