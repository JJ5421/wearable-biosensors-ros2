...
: ${AMENT_CURRENT_PREFIX:="/home/jj/wearable-biosensors-ros2/install/manager"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/manager/environment/pythonpath.sh"
