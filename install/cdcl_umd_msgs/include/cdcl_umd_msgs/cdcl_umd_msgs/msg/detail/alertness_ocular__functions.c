...
cdcl_umd_msgs__msg__AlertnessOcular__init(cdcl_umd_msgs__msg__AlertnessOcular * msg)
{
  ...
  {
    bool success = rosidl_runtime_c__String__assign(&msg->hypothesis_names.data[0], "open");
    if (!success) {
      goto abort_init_2;
    }
  }
  {
    bool success = rosidl_runtime_c__String__assign(&msg->hypothesis_names.data[1], "closed");
    if (!success) {
      goto abort_init_3;
    }
  }
  {
    bool success = rosidl_runtime_c__String__assign(&msg->hypothesis_names.data[2], "NT");
    if (!success) {
      goto abort_init_4;
    }
  }
...
cdcl_umd_msgs__msg__AlertnessOcular__create()
{
  ...
  cdcl_umd_msgs__msg__AlertnessOcular * msg = (cdcl_umd_msgs__msg__AlertnessOcular *)allocator.allocate(sizeof(cdcl_umd_msgs__msg__AlertnessOcular), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(cdcl_umd_msgs__msg__AlertnessOcular));
  bool success = cdcl_umd_msgs__msg__AlertnessOcular__init(msg);
  if (!success) {
...
cdcl_umd_msgs__msg__AlertnessOcular__destroy(cdcl_umd_msgs__msg__AlertnessOcular * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    cdcl_umd_msgs__msg__AlertnessOcular__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
cdcl_umd_msgs__msg__AlertnessOcular__Sequence__init(cdcl_umd_msgs__msg__AlertnessOcular__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cdcl_umd_msgs__msg__AlertnessOcular * data = NULL;

  if (size) {
    data = (cdcl_umd_msgs__msg__AlertnessOcular *)allocator.zero_allocate(size, sizeof(cdcl_umd_msgs__msg__AlertnessOcular), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = cdcl_umd_msgs__msg__AlertnessOcular__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        cdcl_umd_msgs__msg__AlertnessOcular__fini(&data[i - 1]);
      }
...
cdcl_umd_msgs__msg__AlertnessOcular__Sequence__fini(cdcl_umd_msgs__msg__AlertnessOcular__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      cdcl_umd_msgs__msg__AlertnessOcular__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  cdcl_umd_msgs__msg__AlertnessOcular__Sequence * array = (cdcl_umd_msgs__msg__AlertnessOcular__Sequence *)allocator.allocate(sizeof(cdcl_umd_msgs__msg__AlertnessOcular__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = cdcl_umd_msgs__msg__AlertnessOcular__Sequence__init(array, size);
  if (!success) {
...
cdcl_umd_msgs__msg__AlertnessOcular__Sequence__destroy(cdcl_umd_msgs__msg__AlertnessOcular__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    cdcl_umd_msgs__msg__AlertnessOcular__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
cdcl_umd_msgs__msg__AlertnessOcular__Sequence__are_equal(const cdcl_umd_msgs__msg__AlertnessOcular__Sequence * lhs, const cdcl_umd_msgs__msg__AlertnessOcular__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!cdcl_umd_msgs__msg__AlertnessOcular__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  cdcl_umd_msgs__msg__AlertnessOcular__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(cdcl_umd_msgs__msg__AlertnessOcular);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    cdcl_umd_msgs__msg__AlertnessOcular * data =
      (cdcl_umd_msgs__msg__AlertnessOcular *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!cdcl_umd_msgs__msg__AlertnessOcular__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          cdcl_umd_msgs__msg__AlertnessOcular__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!cdcl_umd_msgs__msg__AlertnessOcular__copy(
