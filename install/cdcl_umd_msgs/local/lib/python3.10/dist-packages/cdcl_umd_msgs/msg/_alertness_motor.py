...
class Metaclass_AlertnessMotor(type):
    """Metaclass of message 'AlertnessMotor'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'cdcl_umd_msgs.msg.AlertnessMotor')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__alertness_motor
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__alertness_motor
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__alertness_motor
            cls._TYPE_SUPPORT = module.type_support_msg__msg__alertness_motor
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__alertness_motor
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'POSTERIORS__DEFAULT': array.array('d', (0.25, 0.25, 0.25, 0.25, )),
            'HYPOTHESIS_NAMES__DEFAULT': ['normal', 'abnormal', 'absent', 'NT'],
        }

    @property
    def NAME(self):
        """Message constant 'NAME'."""
        return Metaclass_AlertnessMotor.__constants['NAME']

    @property
    def TYPE(self):
        """Message constant 'TYPE'."""
        return Metaclass_AlertnessMotor.__constants['TYPE']

    @property
    def NUM_HYPOTHESES(self):
        """Message constant 'NUM_HYPOTHESES'."""
        return Metaclass_AlertnessMotor.__constants['NUM_HYPOTHESES']

    @property
    def MAX_POSTERIOR_INDEX(self):
        """Message constant 'MAX_POSTERIOR_INDEX'."""
        return Metaclass_AlertnessMotor.__constants['MAX_POSTERIOR_INDEX']

    @property
    def POSTERIORS__DEFAULT(cls):
        """Return default value for message field 'posteriors'."""
        return array.array('d', (0.25, 0.25, 0.25, 0.25, ))

    @property
    def HYPOTHESIS_NAMES__DEFAULT(cls):
        """Return default value for message field 'hypothesis_names'."""
        return ['normal', 'abnormal', 'absent', 'NT']


class AlertnessMotor(metaclass=Metaclass_AlertnessMotor):
    """
    Message class 'AlertnessMotor'.
    ...
    def __init__(self, **kwargs):
        ...
        self.posteriors = kwargs.get(
            'posteriors', AlertnessMotor.POSTERIORS__DEFAULT)
        self.hypothesis_names = kwargs.get(
            'hypothesis_names', AlertnessMotor.HYPOTHESIS_NAMES__DEFAULT)
