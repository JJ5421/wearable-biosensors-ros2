...
class Metaclass_AlertnessOcular(type):
    """Metaclass of message 'AlertnessOcular'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'cdcl_umd_msgs.msg.AlertnessOcular')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__alertness_ocular
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__alertness_ocular
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__alertness_ocular
            cls._TYPE_SUPPORT = module.type_support_msg__msg__alertness_ocular
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__alertness_ocular
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'HYPOTHESIS_NAMES__DEFAULT': ['open', 'closed', 'NT'],
        }

    @property
    def NAME(self):
        """Message constant 'NAME'."""
        return Metaclass_AlertnessOcular.__constants['NAME']

    @property
    def TYPE(self):
        """Message constant 'TYPE'."""
        return Metaclass_AlertnessOcular.__constants['TYPE']

    @property
    def NUM_HYPOTHESES(self):
        """Message constant 'NUM_HYPOTHESES'."""
        return Metaclass_AlertnessOcular.__constants['NUM_HYPOTHESES']

    @property
    def MAX_POSTERIOR_INDEX(self):
        """Message constant 'MAX_POSTERIOR_INDEX'."""
        return Metaclass_AlertnessOcular.__constants['MAX_POSTERIOR_INDEX']
    ...
    def HYPOTHESIS_NAMES__DEFAULT(cls):
        ...
        return ['open', 'closed', 'NT']


class AlertnessOcular(metaclass=Metaclass_AlertnessOcular):
    """
    Message class 'AlertnessOcular'.
    ...
    def __init__(self, **kwargs):
        ...
        self.posteriors = kwargs.get(
            'posteriors', AlertnessOcular.POSTERIORS__DEFAULT)
        self.hypothesis_names = kwargs.get(
            'hypothesis_names', AlertnessOcular.HYPOTHESIS_NAMES__DEFAULT)
