...
class Metaclass_RespiratoryDistress(type):
    """Metaclass of message 'RespiratoryDistress'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'cdcl_umd_msgs.msg.RespiratoryDistress')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__respiratory_distress
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__respiratory_distress
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__respiratory_distress
            cls._TYPE_SUPPORT = module.type_support_msg__msg__respiratory_distress
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__respiratory_distress
    ...
    def __prepare__(cls, name, bases, **kwargs):
        ...
        return {
            ...
            'HYPOTHESIS_NAMES__DEFAULT': ['absent', 'present'],
        }

    @property
    def NAME(self):
        """Message constant 'NAME'."""
        return Metaclass_RespiratoryDistress.__constants['NAME']

    @property
    def TYPE(self):
        """Message constant 'TYPE'."""
        return Metaclass_RespiratoryDistress.__constants['TYPE']

    @property
    def NUM_HYPOTHESES(self):
        """Message constant 'NUM_HYPOTHESES'."""
        return Metaclass_RespiratoryDistress.__constants['NUM_HYPOTHESES']

    @property
    def MAX_POSTERIOR_INDEX(self):
        """Message constant 'MAX_POSTERIOR_INDEX'."""
        return Metaclass_RespiratoryDistress.__constants['MAX_POSTERIOR_INDEX']
...
class RespiratoryDistress(metaclass=Metaclass_RespiratoryDistress):
    """
    Message class 'RespiratoryDistress'.
    ...
    def __init__(self, **kwargs):
        ...
        self.posteriors = kwargs.get(
            'posteriors', RespiratoryDistress.POSTERIORS__DEFAULT)
        self.hypothesis_names = kwargs.get(
            'hypothesis_names', RespiratoryDistress.HYPOTHESIS_NAMES__DEFAULT)
