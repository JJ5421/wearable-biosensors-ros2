...
bool cdcl_umd_msgs__msg__april_tag_detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cdcl_umd_msgs.msg._april_tag_detection.AprilTagDetection", full_classname_dest, 56) == 0);
  }
  cdcl_umd_msgs__msg__AprilTagDetection * ros_message = _ros_message;
  {  // header
...
PyObject * cdcl_umd_msgs__msg__april_tag_detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("cdcl_umd_msgs.msg._april_tag_detection");
