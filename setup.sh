...
cd /home/cdcl
sudo git clone https://github.com/JJ5421/wearable-biosensors-ros2.git
sudo chmod 777 -R /home/cdcl/wearable-biosensors-ros2

# Step 7: Make pi_startup.sh executable
echo "Making pi_startup.sh executable..."
sudo chmod +x /home/cdcl/wearable-biosensors-ros2/pi_startup.sh

# Step 8: Change permissions for ros_bags folder, specifically!
echo "Changing permissions for ros_bags..."
sudo chmod 777 /home/cdcl/wearable-biosensors-ros2/ros_bags
...
cd /home/cdcl
sudo git clone https://github.com/joan2937/lg \
    && cd lg \
    && make \
    && sudo make install
...
apt update
sudo wget -O vscode_arm.deb 'https://code.visualstudio.com/sha/download?build=stable&os=linux-deb-arm64'
sudo dpkg -i vscode_arm.deb
sudo rm vscode_arm.deb
